...
const teacherJourney = [
...

  {
    ...
    description: 'Set up Courses, organise materials using our intuitive content management tools.',
  },
...
const studentJourney = [
  ...
  },
  {
    ...
    description: 'Access course materials, lectures and resources available to you convieniently from a centralized location.',
  },
  {
    number: 3,
    journey: "Participate and Learn.",
    description: 'Participate, complete assignments, utilize resources, engage in interactive discussions, collaborate with peers  and contribute to the learning community.',
  },
    ...
    <div className={styles['journey-wrapper']}>
      ...
      <Accordion title='I am an Educator'>
        {teacherJourney.map((item) => 
                ( <FlowCard number={item.number} journey={item.journey} description={item.description}/>))
          }
      </Accordion>
