          ...
          <div className="col-12 col-lg-6">
            <div className="left">
              <div className="left-title">
                About <span className="text-primary">Geek</span>
              </div>

              <div className="left-content">
                <p>
                  At Geek, we understand the power of bringing teaching and
                  learning together in one cohesive platform. We know that
                  education is not just about imparting knowledge but also about
                  fostering growth and inspiring minds. That's why we've built
                  an all-in-one place where educators and learners can thrive
                  together.
                </p>
              </div>
              ...
              <div className="card-item">
                <div className="card-left">
                  <i className="bi bi-mortarboard bg-primary text-light my-icon"></i>
                </div>
              ...
              <div className="card-item">
                <div className="card-left">
                  <i className="bi bi-person-bounding-box bg-primary text-light my-icon"></i>
                </div>
                <div className="card-right">
                  <h6>Help Educators Teach Better</h6>
                  <p>
                    Elevate your teaching game with Geek. Our innovative tools
                    and features empower educators to create captivating
                    lessons, engage students, and deliver impactful learning
                    experiences.
                  </p>
                </div>
              </div>
