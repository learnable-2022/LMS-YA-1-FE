            ...
            <section>
              <div>
                  <label htmlFor="username">
                    Username
                    <MdCheck className={validUserName ? styles.valid : styles.hide}/>
                    <MdOutlineCancel className={validUserName || !userName ? styles.hide : styles.invalid}/>
                  </label>
                  <input 
                    type="text" 
                    id="username"
                    ...
                    <div id="uidnote" className={ userFocus && userName && !validUserName ? styles.suggestions : styles.offscreen }>
              ...
              <div>
                <label htmlFor="address">
                  Eth address
                  <MdCheck className={validAddress ? styles.valid : styles.hide}/>
                  <MdOutlineCancel className={validAddress || !address ? styles.hide : styles.invalid}/>
                </label>
                  <input 
                    type="text" 
                    id="address" 
                    placeholder="0xeA0B965789232112128"
                    value={address}
                    ...
                    <div id="ethnote"
                        className={
                        addressFocus && address && !validAddress ? styles.suggestions : styles.offscreen}
                        >
                      <MdInfoOutline className={styles.svg}/> Please enter a valid Eth address.
                      <br />
              ...
              <div className={styles['pswd-container']}>
                <label htmlFor="password">
                    Password
                    <MdCheck className={validPassword ? styles.valid : styles.hide}/>
                    <MdOutlineCancel className={validPassword || !password ? styles.hide : styles.invalid}/>
                  </label>
                <input 
                  ...
                  <div id="pwdnote" className={ passwordFocus && !validPassword ? styles.suggestions : styles.offscreen }>
              ...
              <div className={styles['pswd-container']}>
                  <label htmlFor="passwordI">
                    Confirm password
                    <MdCheck className={validMatch && matchPasword ? styles.valid : styles.hide}/>
                    <MdOutlineCancel className={validMatch || !matchPasword ? styles.hide : styles.invalid}/>
                  </label>
                  <input 
                    ...
                    />
                    <div id="confirm" className={matchFocus && !validMatch ? styles.suggestions : styles.offscreen}>
