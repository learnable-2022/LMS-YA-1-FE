...
function SFlowII() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(ACCESS_KEY_ENDPOINT + accessKey, {
    ...
    <div className={styles['signup-pg-1']}>
      <div className={styles['left-section-1']}>
        ...
        <form className={styles['form-1']} onSubmit={handleSubmit}>
          ...
          />
          <p>
            Copy and paste your access key in the above field. If you didn’t get
            any access key, please reach out to the organization where you
